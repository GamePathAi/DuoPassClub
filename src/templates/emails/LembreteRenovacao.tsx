    ...
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto', backgroundColor: '#ffffff' }}>
      ...
      <div style={{ padding: '30px 20px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          ...
          <a href="https://duopass.ch/dashboard?tab=billing" 
             style={{ 
          ...
          <a href="https://duopass.ch/cancelamento" 
             style={{ 
      ...
      <div style={{ backgroundColor: '#F9FAFB', padding: '20px', textAlign: 'center', fontSize: '12px', color: '#6B7280' }}>
        ...
        <p style={{ margin: '0', fontSize: '11px' }}>
          ...
          <a href="https://duopass.ch/dashboard?tab=privacy" style={{ color: '#8B5CF6' }}>gerencie suas preferências</a>.
        </p>
      </div>
    </div>
  );
